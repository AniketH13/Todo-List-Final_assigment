...
public class TodoListFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
     ...
     rootView = inflater.inflate(R.layout.fragment_todo_list, container, false);
        ...
        todoRecyclerView = rootView.findViewById(R.id.recycletextview);
    ...
    private class TodoHolder extends RecyclerView.ViewHolder{
        ...
        public TodoHolder(LayoutInflater inflater, ViewGroup parentViewGroup) {
            ...
            mTitle = itemView.findViewById(R.id.title_list);
            mDate = itemView.findViewById(R.id.date_list);
            mDesprition=itemView.findViewById(R.id.description_list);
