...
public class EditTodoFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        txtTitle=rootView.findViewById(R.id.text_title);
        txtDescription=rootView.findViewById(R.id.text_description);
        txtDate=rootView.findViewById(R.id.text_date);
        rgPriority=rootView.findViewById(R.id.group_priority);
        rbHigh=rootView.findViewById(R.id.pri_high);
        rbMedium=rootView.findViewById(R.id.pri_medium);
        rbLow=rootView.findViewById(R.id.pri_low);
        chkIsCompleted=rootView.findViewById(R.id.check_complete);
        btnSave=rootView.findViewById(R.id.save_button);
        btnCancel=rootView.findViewById(R.id.cancel_button);
        txtDate=rootView.findViewById(R.id.text_date);
        ...
        if (todoId!=-1){
            ...
            switch(todo.getPriority()){
                case 1:
                    rgPriority.check(R.id.pri_high);
                    break;
                case 2:
                    rgPriority.check(R.id.pri_medium);
                    break;
                case 3:
                    rgPriority.check(R.id.pri_low);
            }
